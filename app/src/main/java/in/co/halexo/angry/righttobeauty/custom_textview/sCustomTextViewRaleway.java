...
public class sCustomTextViewRaleway extends AppCompatTextView {
    public sCustomTextViewRaleway(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public sCustomTextViewRaleway(Context context){
        super(context);
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "font/" + getResources().getString(R.string.fontRegular)));
    }
}
